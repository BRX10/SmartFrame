...
class SignupAPI(Resource):
    def post(self):
        # Signup desactivable via variable d'environnement (defaut: desactive en prod)
        if os.getenv("SIGNUP_ENABLED", "false").lower() not in ("true", "1", "yes"):
            return {'message': 'Inscription desactivee'}, 403
        try:
